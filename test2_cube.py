...
#Top
first_layer = np.hstack((T, F, R, L, B, D))

# or np.unique(F[2]) != 2 or np.unique(R[2]) != 3 or np.unique(L[2]) != 4 or np.unique(B[0]) != 5)
while ((D[0][0] != 6) or (D[0][1] != 6) or (D[0][2] != 6) or (D[1][0] != 6) or (D[1][1] != 6) or (D[1][2] != 6) or (D[2][0] != 6) or (D[2][1] != 6) or (D[2][2] != 6) or (F[2][0] != 2) or (F[2][1] != 2) or (F[2][2] != 2) or (R[2][0] != 3) or (R[2][1] != 3) or (R[2][2] != 3) or (L[2][0] != 4) or (L[2][1] != 4) or (L[2][2] != 4) or (B[0][0] != 5) or (B[0][1] != 5) or (B[0][2] != 5)):
    while (T[0][0] == 6 or T[0][2] == 6 or T[2][2] == 6 or T[2][0] == 6):
        while T[0][0] == 6:
            if T[0][0] == 6:
    ...
    while (F[0][0] == 6 or F[0][2] == 6 or F[2][2] == 6 or F[2][0] == 6):
        while F[0][0] == 6:
            if (F[0][0] == 6 and L[0][2] == 4 and T[2][0] == 2):
                rotation('u1')
                rotation('l1')
                rotation('u')
                rotation('l')
        ...
        while F[0][2] == 6:
            if (F[0][2] == 6 and R[0][0] == 3 and T[2][2] == 2):
                rotation('u')
                rotation('r')
                rotation('u1')
                rotation('r1')
        ...
        while F[2][0] == 6:
            if (F[2][0] == 6 and L[2][2] == 2 and D[0][0] == 4):
                rotation('f')
                rotation('u')
                rotation('f1')
                rotation('u1')
        ...
        while F[2][2] == 6:
            if (F[2][0] == 6 and R[2][0] == 2 and D[0][2] == 3):
                rotation('f1')
                rotation('u1')
                rotation('f')
                rotation('u')
    ...
    while (R[0][0] == 6 or R[0][2] == 6 or R[2][2] == 6 or R[2][0] == 6):
        while R[0][0] == 6:
            if (R[0][0] == 6 and F[0][2] == 2 and T[2][2] == 2):
                rotation('u1')
                rotation('f1')
                rotation('u')
                rotation('f')
        ...
        while R[0][2] == 6:
            if (R[0][2] == 6 and B[2][2] == 5 and T[0][2] == 3):
                rotation('u')
                rotation('b')
                rotation('u1')
                rotation('b1')
        ...
        while R[2][0] == 6:
            if (R[2][0] == 6 and F[2][2] == 3 and D[0][2] == 2):
                rotation('r')
                rotation('u')
                rotation('r1')
                rotation('u1')
        ...
        while R[2][2] == 6:
            if (R[2][2] == 6 and B[0][2] == 3 and D[2][2] == 5):
                rotation('r1')
                rotation('u1')
                rotation('r')
                rotation('u')
    ...
    while (L[0][0] == 6 or L[0][2] == 6 or L[2][2] == 6 or L[2][0] == 6):
        while L[0][0] == 6:
            if (L[0][0] == 6 and B[2][0] == 5 and T[0][0] == 4):
                rotation('u1')
                rotation('b1')
                rotation('u')
                rotation('b')
        ...
        while L[0][2] == 6:
            if (L[0][2] == 6 and F[0][0] == 2 and T[2][0] == 4):
                rotation('u')
                rotation('f')
                rotation('u1')
                rotation('f1')
        ...
        while L[2][0] == 6:
            if (L[2][0] == 6 and B[0][0] == 4 and D[2][0] == 5):
                rotation('l')
                rotation('u')
                rotation('l1')
                rotation('u1')
        ...
        while L[2][2] == 6:
            if (L[2][2] == 6 and F[2][0] == 4 and D[0][0] == 2):
                rotation('l1')
                rotation('u1')
                rotation('l')
                rotation('u')
    ...
    while (B[0][0] == 6 or B[0][2] == 6 or B[2][2] == 6 or B[2][0] == 6):
        while B[2][2] == 6:
            if (B[2][2] == 6 and R[0][2] == 3 and T[0][2] == 5):
                rotation('u1')
                rotation('r1')
                rotation('u')
                rotation('r')
        ...
        while B[2][0] == 6:
            if (B[2][0] == 6 and L[0][0] == 4 and T[0][0] == 5):
                rotation('u')
                rotation('l')
                rotation('u1')
                rotation('l1')
        ...
        while B[0][2] == 6:
            if (B[0][2] == 6 and R[2][2] == 5 and D[2][2] == 3):
                rotation('b')
                rotation('u')
                rotation('b1')
                rotation('u1')
        ...
        while B[0][0] == 6:
            if (B[0][0] == 6 and L[2][0] == 5 and D[2][0] == 4):
                rotation('b1')
                rotation('u1')
                rotation('b')
                rotation('u')
    ...
    while (D[0][0] == 6 and F[2][0] != 2 and L[2][2] != 4):
        rotation('l1')
        rotation('u1')
        rotation('l')
        solutions.append('l1')
    ...
    while (D[0][2] == 6 and F[2][2] != 2 and R[2][0] != 3):
        rotation('r')
        rotation('u')
        rotation('r1')
        solutions.append('r')
    ...
    while (D[2][0] == 6 and L[2][0] != 4 and B[0][0] != 5):
        rotation('l')
        rotation('u')
        rotation('l1')
        solutions.append('l')
    ...
    while (D[2][2] == 6 and R[2][2] != 3 and B[0][2] != 5):
        rotation('r1')
        rotation('u')
        rotation('r')
        solutions.append('r1')
