...
def second_layer():
    global T, F, R, L, B, D
    while ((F[0][1] != 1 and T[2][1] != 1) or (R[0][1] != 1 and T[1][2] != 1) or (L[0][1] != 1 and T[1][0] != 1) or (B[2][1] != 1 and T[0][1] != 1)):
        #Front
...
# Start second layer
while (F[1][0] != 2 or F[1][2] != 2 or R[1][0] != 3 or R[1][2] != 3 or L[1][0] != 4 or L[1][2] != 4 or B[1][0] != 5 or B[1][2] != 5):
    while ((F[0][1] != 1 and T[2][1] != 1) or (R[0][1] != 1 and T[1][2] != 1) or (L[0][1] != 1 and T[1][0] != 1) or (B[2][1] != 1 and T[0][1] != 1)):
        # Front
        if (F[0][1] != 1 and T[2][1] != 1):
            if F[0][1] == 2:
