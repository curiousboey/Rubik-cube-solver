...
def algo_oll():
    ...
    if (T[0][1] == 1 and T[1][0] == 1 and T[1][1] == 1 and T[1][2] == 1 and T[2][0] == 1 and T[2][1] == 1 and F[0][2] == 1 and T[0][2] != 1):
        ...
        solutions.append('u')
        solutions.append('r1')
    elif (T[0][1] == 1 and T[1][0] == 1 and T[1][1] == 1 and T[1][2] == 1 and T[0][2] == 1 and T[2][1] == 1 and F[0][0] == 1):
        rotation('r')
        rotation('u')
        rotation('u')
        rotation('r1')
...
while (T[0][1] != 1 or T[1][0] != 1 or T[1][1] != 1 or T[1][2] != 1 or T[2][1] != 1 or T[0][2] != 1 or T[2][0] != 1 or T[0][0] != 1 or T[2][2] != 1):
    if (T[0][1] == 1 and T[1][0] == 1 and T[1][1] == 1 and T[1][2] == 1 and T[2][0] == 1 and T[2][1] == 1 and F[0][2] == 1):
        ...
        solutions.append('u')
        algo_oll()
    elif (T[0][1] == 1 and T[1][0] == 1 and T[1][1] == 1 and T[1][2] == 1 and T[2][1] == 1 and T[0][0] == 1 and L[0][2] == 1):
        rotation('u1')
        solutions.append('u1')
        algo_oll()
